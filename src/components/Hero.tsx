    ...
    <section id="home" className="relative pt-8 pb-16 md:pt-16 md:pb-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center space-y-8">
          ...
          {/* Main Title */}
          <h1 className="text-5xl md:text-7xl font-semibold tracking-tight leading-[1.05] text-slate-900">
            Build Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-600 font-semibold">Business</span> Beyond Limits
          </h1>

          {/* Subtitle */}
          <p className="text-[clamp(1.125rem,1.5vw,1.375rem)] text-slate-600 font-medium leading-relaxed max-w-2xl mx-auto">
            We create modern high-converting websites designed to help businesses stand out connect with more customers and grow online.
          </p>
