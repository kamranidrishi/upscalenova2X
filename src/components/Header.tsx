      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="flex items-center justify-between h-16">
          ...
          <a href="#" className="flex items-center gap-3 group">
            <div className="w-12 h-12 flex items-center justify-center shrink-0 p-1.5 rounded-xl bg-white shadow-xs border border-slate-200/90 group-hover:border-indigo-400 group-hover:shadow-indigo-500/10 transition-all duration-300 overflow-hidden">
              <img 
                src="/logo.png" 
