export type PlanType = 'Base' | 'Pro' | 'Mega';
export type BusinessType = 'cafe' | 'restaurant' | 'real-estate' | 'gym' | 'law-firm' | 'marketing' | 'finance' | 'ai' | 'form';
export type CategoryType = 'Café' | 'Restaurant' | 'Flat / Real Estate' | 'Gym' | 'Law Firm' | 'Marketing' | 'Finance' | 'AI / SaaS' | 'Services';

export interface DemoItem {
  id: string;
  businessId: string; // To link Base, Pro, Mega versions of the same business
  title: string;
